...
class TestTrampoline(unittest.TestCase):
    def test_trampoline1(self):
        ...
        self.assertEqual(ab_test(b="b_val3", a="a_val3"), "a is 'a_val3', b is 'b_val3'")
    ...
    def test_trampoline3(self):
        ...
        tohil.eval("""proc abc_test {a {b b_default} {c c_default}} {return "a is '$a', b is '$b', c is '$c'"}""")

        d = tohil.procs.probe_proc("abc_test")
        exec(d, globals())

        self.assertEqual(abc_test("a_val"), "a is 'a_val', b is 'b_default', c is 'c_default'")
        self.assertEqual(abc_test("a_val", "b_val"), "a is 'a_val', b is 'b_val', c is 'c_default'")
        self.assertEqual(abc_test("a_val2", b="b_val2"), "a is 'a_val2', b is 'b_val2', c is 'c_default'")
        self.assertEqual(abc_test(b="b_val3", a="a_val3"), "a is 'a_val3', b is 'b_val3', c is 'c_default'")
        self.assertEqual(abc_test(b="b_val4", a="a_val4", c="c_val4"), "a is 'a_val4', b is 'b_val4', c is 'c_val4'")
        self.assertEqual(abc_test(c="c_val5", a="a_val5"), "a is 'a_val5', b is 'b_default', c is 'c_val5'")
        self.assertEqual(abc_test("a_val6", c="c_val6"), "a is 'a_val6', b is 'b_default', c is 'c_val6'")
