#
# Tohil documentation build configuration file
#
# significantly cribbed from Python docuemntation
#
...
_stdauthor = r'FlightAware Developers\\and other contributors'
latex_documents = [
    ('installing/index', 'installing.tex',
     'Installing Python Modules', _stdauthor, 'manual'),
    ('reference/index', 'library.tex',
     'Tohil Reference', _stdauthor, 'manual'),
    ('tutorial/index', 'tutorial.tex',
     'Tohil Tutorial', _stdauthor, 'manual'),
    ('whatsnew/' + version, 'whatsnew.tex',
     'What\'s New in Tohil', 'FA Devs', 'howto'),
]
...
epub_author = 'Tohil Documentation Authors'
epub_publisher = 'FlightAware LLC'
